...
2. Set Edge Function secrets: `SQUARE_ACCESS_TOKEN`, `SQUARE_WEBHOOK_SIGNATURE_KEY`, `SQUARE_WEBHOOK_URL`, `SQUARE_ENVIRONMENT=production`, and optionally `SQUARE_VERSION=2026-08-19`.
